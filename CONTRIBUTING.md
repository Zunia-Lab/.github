...
Open a feature request issue describing the problem, proposed solution, and alternatives considered.

### Pull requests

1. Fork the repository and create a branch from `main`.
2. Make focused changes with clear commit messages.
3. Run tests and linters locally when the repo provides them.
...
Unless stated otherwise in a repository, contributions are licensed under the same license as the project (typically Apache-2.0 or MIT).
